...
speed = 370
spritesheet = SpriteSheet(path_join("assets", "sprites", "entities", "marisa_forward.png")).crop((25, 50))
bulletSpritesheet = SpriteSheet(path_join("assets", "sprites", "projectiles_and_items", "marisa_bullet.png")).crop((32, 32))
...
def attack(fire_point: Vector2, power: int):
    ...
    bullet_data = BulletData(bulletSpritesheet, Collider(5, offset=Vector2.up() * 10))
